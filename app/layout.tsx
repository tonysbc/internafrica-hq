              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-20">
                  ...
                  <nav className="hidden md:flex gap-8 items-center font-medium text-gray-600">
                    ...
                    <Link 
                      href="/apply" 
                      className="px-6 py-2 bg-brand-primary text-white rounded-full hover:bg-brand-primary/90 transition-all font-semibold"
                    >
                      Apply Now
                    </Link>
                  </nav>
              ...
              <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-4 gap-12 mb-12">
                <div className="col-span-1 md:col-span-2">
                  ...
                  <p className="text-gray-300 max-w-sm">
                    Connecting global talent with meaningful volunteering and internship opportunities in Tanzania & Zanzibar. 
                    Licensed & Registered.
                  </p>
                </div>
                <div>
